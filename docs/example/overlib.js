...
var olOp = (navigator.userAgent.toLowerCase().indexOf('opera')
    > -1 && document.createTextNode); // Opera 7
...
function olMain()
{
    ...
    if (o3_background != "" || o3_fullhtml) {
        ...
        if (o3_height
            > 0) o3_height = (styleType ? "height=\"" + o3_height + "\"" : o3_height);
        else o3_height = "";
        ...
        if (o3_cap == "") {
            ...
            if (o3_sticky) {
                // Show close text
                layerhtml = runHook('ol_content_caption', FALTERNATE, o3_css, o3_text,
                    o3_cap, o3_close);
            } else {
                // No close text
                layerhtml = runHook('ol_content_caption', FALTERNATE, o3_css, o3_text,
...
function ol_content_simple(text)
{
    ...
    var txt = '<table width="' + o3_width + '" border="0" cellpadding="' + o3_border
        + '" cellspacing="0" '
...
function ol_content_caption(text, title, close)
{
    ...
    if (o3_closeclick
        == 1) closeevent = (o3_closetitle ? "title='" + o3_closetitle + "'" : "")
        + " onclick";

    if (o3_capicon != "") {
        nameId = ' hspace = \"5\"' + ' align = \"middle\" alt = \"\"';

        if (typeof o3_dragimg != 'undefined' && o3_dragimg) nameId = ' hspace=\"5\"'
            + ' name=\"' + o3_dragimg + '\" id=\"' + o3_dragimg
            + '\" align=\"middle\" alt=\"Drag Enabled\" title=\"Drag Enabled\"';
        o3_capicon = '<img src=\"' + o3_capicon + '\"' + nameId + ' />';
    }

    if (close != "") closing = '<td ' + (!o3_compatmode
        && o3_closefontclass ? 'class="' + o3_closefontclass : 'align="RIGHT')
        + '"><a href="javascript:return ' + fnRef + 'cClick();"' + ((o3_compatmode
        && o3_closefontclass) ? ' class="' + o3_closefontclass + '" ' : ' ')
        + closeevent + '="return ' + fnRef + 'cClick();">'
        + (o3_closefontclass ? '' : wrapStr(0, o3_closesize, 'close')) + close
        + (o3_closefontclass ? '' : wrapStr(1, o3_closesize, 'close')) + '</a></td>';
    txt = '<table width="' + o3_width + '" border="0" cellpadding="' + o3_border
        + '" cellspacing="0" '
        + (o3_bgclass ? 'class="' + o3_bgclass + '"' : o3_bgcolor + ' ' + o3_bgbackground
            + ' ' + o3_height)
        ...
        + o3_capicon + title
        + (o3_captionfontclass ? '' : wrapStr(1, o3_captionsize) + '</b>') + '</td>'
        + closing + '</tr></table><table width="100%" border="0" '
        + ((olNs4 || !cpIsMultiple) ? 'cellpadding="' + o3_cellpad + '" ' : '')
        + 'cellspacing="0" '
        + (o3_fgclass ? 'class="' + o3_fgclass + '"' : o3_fgcolor + ' ' + o3_fgbackground
            + ' ' + o3_height) + '><tr><td valign="TOP"'
...
function ol_content_background(text, picture, hasfullhtml)
{
    if (hasfullhtml) {
        ...
        txt = '<table width="' + o3_width
            ...
            + o3_padxl + '"></td><td valign="TOP" width="'
            + (o3_width - o3_padxl - o3_padxr)
            + (o3_textfontclass ? '" class="' + o3_textfontclass : '') + '">'
            + (o3_textfontclass ? '' : wrapStr(0, o3_textsize, 'text')) + text
            + (o3_textfontclass ? '' : wrapStr(1, o3_textsize)) + '</td><td width="'
            + o3_padxr + '"></td></tr><tr><td colspan="3" height="' + o3_padyb
            + '"></td></tr></table>';
    }
...
function placeLayer()
{
    ...
    winoffset = (olIe4)
        ? eval('o3_frame.' + docRoot + '.scrollLeft') : o3_frame.pageXOffset;
    ...
    scrolloffset = (olIe4)
        ? eval('o3_frame.' + docRoot + '.scrollTop') : o3_frame.pageYOffset;
    ...
    for (i = 0; i < ar.length; i++) {
        if (mode < 0) {
            ...
            if (ar[i] == MOUSEOFF) {
                ...
                if (pf != 'ol_' && eval(pf + 'mouseoff') && typeof v == 'number'
                    && (v < pmStart || v > pmUpper)) olHideDelay = ar[++i];
                continue;
            }
...
function cursorOff()
{
    ...
    var right = left + (over.offsetWidth
        >= parseInt(o3_width) ? over.offsetWidth : parseInt(o3_width));
    var bottom =
        top + (over.offsetHeight >= o3_aboveheight ? over.offsetHeight : o3_aboveheight);
...
{
    o3_text = (callme ? ( typeof callme
        == 'string' ? (/.+\(.*\)/.test(callme) ? eval(callme) : callme) : callme())
...
function OLonLoad_handler(e)
{
    ...
    if (window.removeEventListener
        && e.eventPhase == 3) window.removeEventListener("load", OLonLoad_handler, false);
...
function wrapStr(endWrap, fontSizeStr, whichString)
{
    ...
    if (endWrap) return(hasDims && !olNs4) ? (isClose ? '</span>' : '</div>') : '</font>';
        ...
        return(hasDims && !olNs4)
            ? (isClose ? '<span style="font-family: ' + quoteMultiNameFonts(eval(fontStr))
                + '; color: ' + eval(fontColor) + '; font-size: ' + fontSizeStr
                + ';">'
            : '<div style="font-family: ' + quoteMultiNameFonts(eval(fontStr))
                + '; color: ' + eval(fontColor) + '; font-size: ' + fontSizeStr
                + ';">')
...
function setCellPadStr(parameter)
{
    ...
    Str += ((ary.length == 1)
        ? ary[0] + 'px;' : top + 'px ' + right + 'px ' + bottom + 'px ' + left + 'px;');
...
function horizontalPlacement(browserWidth, horizontalScrollAmount, widthFix)
{
    ...
    if (o3_fixx > -1 || o3_relx != null) {
        // Fixed position
        placeX = (o3_relx
            != null ? (o3_relx < 0 ? winoffset + o3_relx + iwidth - parsedWidth - widthFix
...
function verticalPlacement(browserHeight, verticalScrollAmount)
{
    ...
    if (o3_fixy > -1 || o3_rely != null) {
        // Fixed position
        placeY = (o3_rely
            != null ? (o3_rely < 0 ? scrolloffset + o3_rely + iheight - parsedHeight
                : scrolloffset + o3_rely) : o3_fixy);
    } else {
        // If VAUTO, decide what to use.
        if (o3_vauto == 1) {
            if ((o3_y - scrolloffset) > (iheight / 2) && o3_vpos == BELOW
    ...
    if (o3_frame.innerWidth) w = o3_frame.innerWidth;
        ...
        && eval("typeof o3_frame." + docRoot + ".clientWidth=='number'")
            && eval('o3_frame.' + docRoot
                + '.clientWidth')) w = eval('o3_frame.' + docRoot + '.clientWidth');
    return w;
}
...
function layerReference(id) { return(olNs4 ? o3_frame.document.layers[id] : (document.all
...
function registerHook(fnHookTo, fnRef, hookType, optPm)
{
    ...
    if (typeof hookPts[fnHookTo]
        == 'undefined') hookPts[fnHookTo] = new FunctionReference();
    ...
    if (hookType != null) {
        if (hookType == FREPLACE) {
            ...
            if (fnHookTo.indexOf('ol_content_')
                > -1) hookPt.alt[pms[CSSOFF - 1 - pmStart]] = fnRef;
            ...
            if (typeof fnRef
                == 'object') hookPt = hookPt.concat(fnRef); // add other functions
...
function runHook(fnHookTo, hookType)
{
    ...
    if (hookType == FREPLACE) {
        ...
        if (typeof l == 'undefined'
            || !(l = l.ovload)) rtnVal = eval(fnHookTo + '(' + arS + ')');
...
function meets(reqdVersion) { return(!reqdVersion)
    ? false : this.simpleversion >= Math.round(100 * parseFloat(reqdVersion)); }
