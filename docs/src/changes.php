...
are really facets of the same thing - lack of input validation. 0.97b improves this a great deal.</p>
    ...
    <li>Moved all PHP that doesn't need to be web-accessible into lib. See <a href="main.html#security">Security notes</a>.</li>
    ...
    <li>'External Script' datasource plugin is disabled by default in new installs (NOT upgrades though!)</li>
            ...
            <ul>
                ...
                dsstats plugins (thanks sh0x)</li>

                <li>'classic' legend drew 'hidden' colour values for things like key
                background colour. (thanks jmayniac)</li>
            ...
            <ul>
                ...
                - see top of editor.php (and install guide)</li>
            </ul>
            ...
            <ul>
                ...
                directory (e.g. Ubuntu, Debian *again*)</li>
            ...
            <ul>
                ...
                - and the colours are nicer too.</li>
                ...
                (overwrites settings otherwise)</li>
                ...
                to have a SCALE of absolute values</li>
            ...
            <ul>
                ...
                least) the editor. (thanks toe_cutter)</li>
            ...
            <ul>
                ...
                relatively-positioned nodes and vias</li>
            ...
            <ul>
                ...
                link arrow. (and 'edge' for the usual)</li>
                ...
                (mainly for external ! scripts)</li>

                <li>"KEYSTYLE tags"
                - like classic, but uses the scale tags instead of percentages.</li>
            ...
            <ul>
                ...
                'out' side. New editor will handle this better.</li>
            </ul>
            ...
            <ul>
                ...
                pull interface oper/admin status, for example, now.</li>
            </ul>
            ...
            <ul>
                ...
                the plugin can cache results internally.</li>
            ...
            <ul>
                ...
                calculate work for half-duplex links</li>
                ...
                side of links (based on idea from llow)</li>

                <li>OVERLIBGRAPH (and IN/OUT versions) can take multiple URLs separated
                by spaces (again from idea by llow)</li>
                ...
                too. Making debugging-by-mail easier.</li>
            ...
            <ul>
                ...
                for by Stellar Consulting - Thanks!)</li>
                ...
                <a href = "targets.html">targets.html</a> for more info on this one.</li>

                <li>Editor
                - Align horizontal and Align-vertical for links. Calculates link offsets
                to make link vertical/horizontal.</li>
            </ul>
            ...
            <ul>
                ...
                and Aggregate
                - easier to tell who does what (Plugin -&gt; Weathermap: View Maps)</li>
            ...
            <ul>
                ...
                as well as a map number - useful for crosslinks</li>
                ...
                now, too (like availability and response times)</li>

                <li>Picking Cacti sources from editor has a javascript "live filter"
                feature now (needs a little work)</li>
                ...
                you can see the coordinates</li>
                ...
                - useful for heirarchies of maps with a parent.</li>

                <li>scale: prefix for RRD datasource
                - multiply/divide by any value as you read an rrd datasource</li>
            </ul>
            ...
            <ul>
                ...
                part of a curved link to make a sensible result (I like this one).</li>

                <li>The editor will let you pick an INFOURL and OVERLIBGRAPH for a NODE
                from your Cacti graphs (but not a TARGET yet).</li>
                ...
                version</strong>. This file has changed.</li>
                ...
                the 'classic' style legend for that scale.</li>
            </ul>
            ...
            <ul>
                ...
                <em>only</em> errors in the standard 'LOW' logging setting.</li>
                ...
                traffic (which you can measure), to leave the Internet traffic.</li>
                ...
                described in the installation instructions.</li>
            ...
            <ul>
                ...
                by WriteConfig) anymore</li>

                <li>The MRTG plugin made some assumptions that broke handling of MRTG
                html files on remote systems. It doesn't now.</li>
            ...
            <ul>
                ...
                - read the up/down status of a host in Cacti</li>

                <li><strong>gauge</strong>
                - Read RRD values without any special treatment.</li>
            </ul>
            ...
            <ul>
                ...
                specify a 0-0 SCALE line and it will always take precedence.</li>

                <li>Cacti plugin doesn't assume 'admin' user always exists, and that
                users are never deleted.</li>
