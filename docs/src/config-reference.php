<?php include 'vars.php'; $PAGE_TITLE='Configuration Reference'; include
 ...
 positioned! </p> 
 <p xmlns="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude">You can also specify a relative position to another node in polar coordinates, with an angle (in degrees) and a distance. This 
