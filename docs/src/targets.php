...
NODE firewall_status
    ...
    <h3><a id="snmp"></a>SNMPv1 value</h3>
    ...
    <hr/>
    <h3><a id="snmp2"></a>SNMPv2c value</h3>

    <div class="definition">TARGET
        snmp2c:<em>community</em>:<em>host</em>:<em>in_oid</em>:<em>out_oid</em>
    </div>

    <p>This is the same as the SNMPv1 target above, but for SNMPv2c agents. These are much more common
        nowadays.</p>

    <hr/>
    <h3><a id="snmp3"></a>SNMPv3 value</h3>
