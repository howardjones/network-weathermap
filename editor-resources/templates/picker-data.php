...
<form name="mini">
    ...
    <span class="ds_includegraph" style="display: none;"><input id="overlib" name="overlib" type="checkbox" value="1"> <label for="overlib">Set both OVERLIBGRAPH and INFOURL (as well as TARGET).</label><br /></span>
    <span class="aggregate_choice"  style="display: none;"><input id="aggregate" name="aggregate" type="checkbox" value="1"> <label for="aggregate">Append TARGET to existing one (Aggregate)</label><br /></span>
    <span class="ds_dsstats" style="display: none;"><input id="dsstats" name="dsstats" type="checkbox" value="1"> <label for="dsstats">Generate 'dsstats' target instead of rrdtool.</label><br /></span>
</form>
