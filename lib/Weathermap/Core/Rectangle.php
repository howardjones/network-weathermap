...
class Rectangle
{
    ...
    public function __construct($xPoint1, $yPoint1, $xPoint2, $yPoint2)
    {
        ...
        $this->topLeft = new Point($xPoint1, $yPoint1);
        $this->bottomRight = new Point($xPoint2, $yPoint2);
    }
    ...
    {
        return new Rectangle($this->topLeft->x, $this->topLeft->y, $this->bottomRight->x, $this->bottomRight->y);
    }
