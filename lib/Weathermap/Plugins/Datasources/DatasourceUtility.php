...
class DatasourceUtility
{
     ...
     * @return array
     */
    public static function getCactiHintData(&$item, $local_data_id)
    {
        $map = $item->owner;
     ...
     * @param array $to_set
     */
    public static function determineCactiInterfaceSpeed(&$item, $to_set)
    {
     ...
     * @return array
     */
    public static function getCactiSnmpCache($local_data_id)
    {
        $to_set = array();
