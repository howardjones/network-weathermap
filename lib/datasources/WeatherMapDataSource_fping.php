    ...
    function ReadData($targetstring, &$map, &$item)
    {
        ...
        if (preg_match("/^fping:(\S+)$/", $targetstring, $matches)) {
            ...
            if (is_executable($this->fping_cmd)) {
                ...
                warn(
                    "FPing ReadData: Can't find fping executable. Check path at line 19 of WeatherMapDataSource_fping.php [WMFPING01]\n");
            }
        }

        debug("FPing ReadData: Returning (" . ($data[IN] === NULL ? 'NULL' : $data[IN])
