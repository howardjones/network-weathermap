...
?>
	...
	<script type="text/javascript" src="editor-resources/jquery-1.10.1.min.js" ></script>
	<script type="text/javascript" src="editor-resources/bootstrap/js/bootstrap.min.js" ></script>
	<script src="editor-resources/editor13.js" type="text/javascript" ></script>
...
?>
  ...
  <div class="container" id="wmmaincontainer">
    <?php if($log != "") { print '<div class="alert alert-info">' . htmlspecialchars($log) . '</div>'; } ?>
  <form action="" method="post" name="frmMain" >
	<div align="center" id="mainarea">
	 ...
	 <input style="display:none" type="image"  width="<?php echo $map->width?>" height="<?php echo $map->height?>" 
	  src="<?php echo $imageurl; ?>" id="xycapture" /><img src=
	  "<?php echo $imageurl; ?>" width="<?php echo $map->width?>" height="<?php echo $map->height?>" id="existingdata" alt="Weathermap" usemap="#weathermap_imap"
	   />
	   
	   <div class="debug control-group">
	   <input type="text"  class="input-mini" name="mapname" value="<?php echo htmlspecialchars($mapname); ?>" />
	   <input type="text"  class="input-mini" id="action" name="action" value="<?php echo htmlspecialchars($newaction); ?>" />
	  <input type="text"   class="input-mini" name="param" id="param" value="" />
            <input type="text"   class="input-mini" name="param2" id="param2" value="<?php echo htmlspecialchars($param2); ?>" />
...
?>
	...
	<!-- Node Properties -->
	<div id="dlgNodeProperties" class="modal hide fade">
	  <div class="modal-header">
		<h3>Node Properties</h3>
		<div class="btn-toolbar">
		
		<div class="btn-group">
		<a id="tb_node_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_node_cancel" class="btn btn-info wm_cancel" title="Cancel any changes">Cancel</a>
		</div>
		<div class="btn-group">
		<a id="node_move" class="btn  btn-info">Move</a>
		<a class="btn btn-info" id="node_delete">Delete</a>
		<a class="btn btn-info" id="node_clone">Clone</a>
		<a class="btn btn-info" id="node_edit">Edit</a>		
		</div>
		</div>
	  </div>
	  ...
	  <div class="modal-body">
	    <input size="6" name="node_name" type="hidden" />
			...
			<input id="node_x" class="inline input-small" name="node_x" size=4 type="text" />,<input id="node_y" class="inline input-small" name="node_y" size=4 type="text" />
			<label>Internal Name</label>
			<input id="node_new_name" name="node_new_name" class="input-medium" type="text" />
		  	<label>Label</label>
			<input id="node_label" name="node_label" type="text" />
		  	<label>Info URL</label>
			<input id="node_infourl" name="node_infourl" class="input-xlarge" type="text" />
		  
			<label>'Hover' Graph URL</label>
			<div class="control-group"><input id="node_hover" name="node_hover" class="input-xlarge" type="text" />
			<a class="btn btn-small btn-info cactinode" id="node_cactipick">Pick</a></div>
...
?>
	  ...
	  <div class="modal-footer" id="node_help">
	...
	<div id="dlgLinkProperties" class="modal hide fade">
	  <div class="modal-header">
		...
		<div class="btn-group">
		<a id="tb_link_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_link_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
		</div>
		<div class="btn-group">
		    <a class="btn  btn-info" id="link_delete">Delete</a>
		    <a class="btn  btn-info" id="link_edit">Edit</a>
		    <a class="btn  btn-info" id="link_via">Via</a>
		</div>
		<div class="btn-group">
		    <a class="btn  btn-info" id="link_vert">Vert</a>
		    <a class="btn  btn-info" id="link_horiz">Horiz</a>
		...
		<input size="6" name="link_name" type="hidden" />
		  ...
		  <table width="100%">
			<tr>
			  ...
			  <td><div class="input-append"><input size="8"  class="input-small" id="link_bandwidth_in" name="link_bandwidth_in" type=
			  "text" /><span class="add-on">bits/sec</span></div></td>
			</tr>
			<tr>
			  <th>Maximum Bandwidth<br />
			  ...
			  'In' or <div class="input-append"><input class="input-small" id="link_bandwidth_out" name="link_bandwidth_out"
			  size="8" type="text" /><span class="add-on">bits/sec</span></div></td>
			</tr>
			<tr>
			  <th>Data Source</th>
			  <td><div class="control-group"><input id="link_target" name="link_target" type="text" /><a id="link_cactipick" class="btn btn-small btn-info cactilink">Pick</a></div></td>
			</tr>
			<tr>
			  <th>Link Width</th>
	  ...
	  <div class="modal-footer" id="link_help">
		Helpful text will appear here, depending on the current
		item selected. It should wrap onto several lines, if it's
		necessary for it to do that.
	  </div>
	...
	<div id="dlgMapProperties" class="modal hide fade">
	  <div class="modal-header">
		<h3>Map Properties</h3>

		<a id="tb_map_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_map_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
...
?>
	  ...
	  <div class="modal-footer" id="map_help">
		Helpful text will appear here, depending on the current
		item selected. It should wrap onto several lines, if it's
		necessary for it to do that.
	  </div>
	...
	<!-- Map Style -->
	<div id="dlgMapStyle" class="modal hide fade">
	  <div class="modal-header">
		<h3>Map Style</h3>
		<a id="tb_mapstyle_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_mapstyle_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
	  ...
	  <div class="modal-footer" id="mapstyle_help">
		Helpful text will appear here, depending on the current
		item selected. It should wrap onto several lines, if it's
		necessary for it to do that.
	  </div>
	...
	<div id="dlgColours" class="modal hide fade">
	  <div class="modal-header">
		<h3>Manage Colors</h3>
		<a id="tb_colours_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_colours_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
	  ...
	  <div class="modal-footer" id="colours_help">
		Helpful text will appear here, depending on the current
		item selected. It should wrap onto several lines, if it's
		necessary for it to do that.
	  </div>
	...
	<div id="dlgImages" class="modal hide fade">
	  <div class="modal-header">
		<h3>Manage Images</h3>
		<a id="tb_images_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_images_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
	  ...
	  <div class="modal-footer" id="images_help">
		Helpful text will appear here, depending on the current
		item selected. It should wrap onto several lines, if it's
		necessary for it to do that.
	  </div>
        ...
        <div id="dlgTextEdit" class="modal hide fade">
	  <div class="dlgTitlebar">
		Edit Map Object
		<a id="tb_textedit_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_textedit_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
	...
	<div id="dlgEditorSettings" class="modal hide fade">
	  <div class="modal-header">
		<h3>Editor Settings</h3>
		<a id="tb_editorsettings_submit" class="btn btn-info wm_submit" title="Submit any changes made">Submit</a>
		<a id="tb_editorsettings_cancel" class="btn btn-info wm_submit" title="Cancel any changes">Cancel</a>
	  </div>

	  <div class="modal-body">
		
			<label>Show VIAs overlay</label>
			...
			<label>Show Relative Positions overlay</label>
	...
	<div id="dlgDataPicker" class="modal hide fade">
	  <div class="modal-header">
		<h3>Data Picker</h3>		
		<a id="tb_editorsettings_cancel" class="btn btn-info" title="Cancel any changes">Cancel</a>
	  </div>

	  <div class="modal-body">
	    <div class="control-group">
		<label id="picker_source">Source</label>
		<select name="source">
		    <option>Cacti Database</option>
		    <option>RRD Directory 1</option>
		    <option>RRD Directory 2</option>
		</select> <img id="picker_source_activity" class="activity" src="editor-resources/activity-indicator.gif" />
	    </div>
		
		<div class="control-group">
		<label id="l1_label">Host</label>
		<select name="level1">
		    <option>Some host</option>
		    <option>Some host</option>
		    <option>Some host</option>
		    <option>Some host</option>
		</select> <img id="picker_level1_activity" class="activity" src="editor-resources/activity-indicator.gif" />
		</div>
		
		<div class="control-group">
		<label id="l2_label">Level 2</label>
		<select name="level2">
		    <option>Some host</option>
		    <option>Some host</option>
		    <option>Some host</option>
		    <option>Some host</option>
		</select> <img id="picker_level2_activity" class="activity" src="editor-resources/activity-indicator.gif" />
		</div>
		
		<label>Filter</label><input name="filter" />
		<input type="checkbox" name="set_urls"> Set both OVERLIBGRAPH and INFOURL.<br />
		
		<div id="datapickerlist">
		    <a href="">Some item</a></br>
		    <a href="">Some item</a></br>
		    <a href="">Some item</a></br>
		    <a href="">Some item</a></br>
		    <a href="">Some item</a></br>
   ...
   <div id="footer">
      <div class="container">
        <p class="muted credit">PHP Weathermap Editor <?php echo $WEATHERMAP_VERSION; ?> - <span id="tb_help"></span></p>
      </div>
    </div>
