...
function weathermap_footer_links()
{
	...
	print '<br />'; 
    html_start_box("<center><a target=\"_blank\" class=\"linkOverDark\" href=\"docs/\">Local Documentation</a> -- <a target=\"_blank\" class=\"linkOverDark\" href=\"http://www.network-weathermap.com/?vs=".$WEATHERMAP_VERSION."\">Weathermap Website</a> -- <a class=\"linkOverDark\" href=\"weathermap-cacti-plugin-editor.php\">Weathermap Editor</a> -- This is version $WEATHERMAP_VERSION</center>", "78%", $colors["header"], "2", "center", "");
	html_end_box(); 
}
...
function maplist()
{
	...
	if( ($last_finish_time - $last_start_time) > $poller_interval ) {
        ...
        print "<div class='wm_note' align='center'>Here are the maps that will be generated by Weathermap. You can add other config files, or create new ones in the editor (if you have permission) by click Add in the top of the box below.</div>";
...
// print $map['sortorder'];
	...
	if($last_stats != "") {
		...
		print "<div align='center'><strong>Last Completed Run:</strong> no data available</div>\n";
	}
...
function addmap_picker($show_all=false)
{
	...
	$loaded[]='index.php';
        ...
        if ($can_edit) {
            print "<p>You can also <a href='weathermap-cacti-plugin-editor.php'>create a new file</a> in the web-based editor. That file can also be based on an existing one, to use as a template.</p>";
        }
