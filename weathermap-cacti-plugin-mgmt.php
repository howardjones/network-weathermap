...
function maplist()
{
    ...
    print
        "<div class='wm_note' align='center'>Here are the maps that will be generated by Weathermap. You can add other config files, or create new ones in the editor (if you have permission) by click Add in the top of the box below.</div>";
