...
function maplist()
{
 ...
 print "<b>Required PHP extensions are not present in your mod_php/ISAPI PHP module. Please check your PHP setup to ensure you have the GD extension installed and enabled.</b><p>";
  ...
  if ($boost_enabled == 'on') {
	...
	html_start_box("<strong>Weathermaps</strong>", "78%", $colors["header"], "3", "center", "weathermap-cacti88-plugin-mgmt.php?action=addmap_picker");
...
function weathermap_map_settings($id)
{
	...
	html_start_box("<strong>$title</strong>", "70%", $colors["header"], "2", "center", "weathermap-cacti88-plugin-mgmt.php?action=map_settings_form&mapid=".intval($id));
...
function weathermap_group_editor()
{
	...
	html_start_box("<strong>Edit Map Groups</strong>", "70%", $colors["header"], "2", "center", "weathermap-cacti88-plugin-mgmt.php?action=group_form&id=0");
