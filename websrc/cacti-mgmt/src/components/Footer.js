    ...
    render() {
        return <div className="wm-footer">
            <span className="wm-footer-element"><FormattedMessage id="this_is_network_weathermap"
                                                                  defaultMessage="This is Network Weathermap"/>
                {this.props.settings.wm_version}</span>
            <span className="wm-footer-element"><a href={this.props.settings.editor_url}><FormattedMessage id="editor" defaultMessage="Editor"/></a></span>
